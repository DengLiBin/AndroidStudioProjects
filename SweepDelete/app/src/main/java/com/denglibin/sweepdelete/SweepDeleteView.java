...
package  com.denglibin.sweepdelete;
...
public class SweepDeleteView extends ViewGroup {
    private static final String TAG = "SweepDeleteView";
    ...
    public SweepDeleteView(Context context) {
        this(context, null);
    }

    public SweepDeleteView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    class MyCallBack extends ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top,
            ...
            ViewCompat.postInvalidateOnAnimation(SweepDeleteView.this);
    ...
    public void open() {
        isOpened = true;
        if (mListener != null) {
            mListener.onSweepChanged(SweepDeleteView.this, isOpened);
        }
    ...
    public interface OnSweepListener {
        ...
        void onSweepChanged(SweepDeleteView view, boolean isOpened);
    }
