package com.denglibin.weichatarticle.view;
 ...
 */
public class ColumHorizontalScrollView  extends HorizontalScrollView {
    /** 传入整体布局  */
    ...
    public ColumHorizontalScrollView(Context context) {
        super(context);
    }

    public ColumHorizontalScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
