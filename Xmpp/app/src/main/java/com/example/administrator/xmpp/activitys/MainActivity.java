...
import com.example.administrator.xmpp.adapter.ViewPagerAdapter;
import com.example.administrator.xmpp.config.Constant;
import com.example.administrator.xmpp.fragment.ContactsFragment;
import com.example.administrator.xmpp.fragment.SessionFragment;
import com.example.administrator.xmpp.service.GetContactsToDb;
...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("消息");
        startService(new Intent(this, GetContactsToDb.class));//启动服务，从服务器获取联系人数据保存到数据库
        initData();
                    ...
                    public void onClick(View v) {
                        ...
                        if(TextUtils.isEmpty(contactId)){
                            ...
                            if(Constant.conn!=null){
                                ...
                                //添加联系人
                                try {
                                    //添加好友时，要在contactId后面加“@pc201604171807/Smack”不然加不上，即使加上了，也不是真正的那个人
                                    roster.createEntry(contactId+"@pc201604171807/Smack",null,new String[]{"friends"});
